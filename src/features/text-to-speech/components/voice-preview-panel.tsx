...
export const VoicePreviewPanel = ({ audioUrl, voice, text }: Props) => {
  const selectedVoiceName = voice?.name ?? "";
  const selectedVoiceSeed = voice?.id ?? "";
  ...
  return (
    <div className="h-full gap-8 flex-col border-t hidden lg:flex flex-1">
      {/* Header */}
